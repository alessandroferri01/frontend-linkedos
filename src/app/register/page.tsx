  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        />
        <div
          className="absolute -bottom-40 -right-40 h-80 w-80 rounded-full opacity-15 blur-3xl"
        ...
        >
          <div className="mb-6 text-center">
            ...
            <p className="mt-1 text-sm" style={{ color: 'var(--text-secondary)' }}>
              Inizia a generare post LinkedIn con l&apos;AI
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="space-y-4">
              <div>
                ...
                />
                {errors.email && (
                  <p className="mt-1.5 text-xs font-medium" style={{ color: 'var(--error)' }}>{errors.email.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.password && (
                  <p className="mt-1.5 text-xs font-medium" style={{ color: 'var(--error)' }}>{errors.password.message}</p>
                )}
              </div>

              <div>
                <label htmlFor="confirmPassword" className="mb-1.5 block text-sm font-medium" style={{ color: 'var(--text-primary)' }}>
                  Conferma Password
                </label>
                <input
                  id="confirmPassword"
                ...
                {errors.confirmPassword && (
                  <p className="mt-1.5 text-xs font-medium" style={{ color: 'var(--error)' }}>{errors.confirmPassword.message}</p>
                )}
              </div>
            </div>
